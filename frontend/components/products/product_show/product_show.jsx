...
class ProductShow extends React.Component {
  ...
  componentDidMount() {
    ...
    this.props.fetchProduct(productId)
		...
		if (this.props.currentUserId) this.props.fetchBasketItems();
  }
							...
							<div className="product-show-information">
								...
								<div className="product-show-add-to-basket">
									...
									<div className="product-show-basket">
										...
										<button id="add-to-basket" onClick={ currentUserId ? this.handleSubmit() : () => this.props.openModal('login') }>ADD TO BASKET</button>
