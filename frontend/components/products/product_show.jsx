...
class ProductShow extends React.Component {
  ...
  render() {
    ...
    return <div className="product-show-page">
				...
				<div className="product-show-main">
					...
					<div className="product-show-info">
						...
						<div className="product-show-price-free-shipping">
							<div className="product-show-price">${product.price}.00</div>
							<div className="product-show-free-shipping">FREE SHIPPING</div>
						</div>
					</div>
            ...
            <label id="product-show-checkbox" className="checkbox">
              ...
              <div className="add-to-basket">
                ...
                <button id="add-to-loves"><i id="heart-add-to-loves" className="fas fa-heart" />ADD TO LOVES</button>
								<div className="product-show-find-in-store-zip-code">
									<div className="find-in-store">
										Find in store
									</div>
									<input className="zip-code" type="text" placeholder="Enter ZIP/Postal Code" />
								</div>
							</div>
						</div>
					</div>
